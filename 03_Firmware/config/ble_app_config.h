...
#define APP_ADV_INTERVAL \
    1600 /**< The advertising interval (in units of 0.625 ms. This value corresponds to 1000 ms). */

#define APP_ADV_DURATION      BLE_GAP_ADV_TIMEOUT_GENERAL_UNLIMITED /**< The advertising duration. Unlimited */
#define APP_BLE_OBSERVER_PRIO 3 /**< Application's BLE observer priority. You shouldn't need to modify this value. */
#define APP_BLE_CONN_CFG_TAG  1 /**< A tag identifying the SoftDevice BLE configuration. */

#define MIN_CONN_INTERVAL                                                                      \
    MSEC_TO_UNITS(1000, UNIT_1_25_MS) /**< Minimum acceptable connection interval (1 seconds). \
                                       */
#define MAX_CONN_INTERVAL                                                                                          \
    MSEC_TO_UNITS(1200, UNIT_1_25_MS)                    /**< Maximum acceptable connection interval (1.2 second). \
                                                          */
