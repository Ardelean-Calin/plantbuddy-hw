...
#define EXPORT_FUNC(f) \
  f:
#define __END__   END
#define __SPACE__ DS8
#define GLOBAL_VAR(val) \
  val:
#define ENDFUNC
#define ALIGN_MEM(n)
...
#else
#ifdef __GNUC__
.syntax unified.cpu cortex - m0.fpu softvfp.thumb
...
/* Change this define to 1 if zero-length arrays are not supported by your
 * compiler. */
//#ifndef __CC_ARM
