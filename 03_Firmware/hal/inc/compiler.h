 ...
 *         Use the NOSTACK_FUNCTION macro to indicate that function should not
 * use any stack. Typical usage is for hard fault handler, to avoid altering the
 * value of the stack pointer. Usage:  NOSTACK_FUNCTION(void
 * my_noretrun_function(void))
 */
 ...
 * in RAM in in a specific section. Usage:  NO_INIT_SECTION(int my_no_init_var,
 * "MySection") Usage:  NO_INIT_SECTION(uint16_t my_no_init_array[10],
 * "MySection")
 */
...
/**
 * @brief  NO_INIT
 *         Use the NO_INIT macro to declare a not initialized variable placed in
 * RAM Linker script has to make sure that section ".noinit" is not initialized
 *         Usage:  NO_INIT(int my_no_init_var)
 *         Usage:  NO_INIT(uint16_t my_no_init_array[10])
 */
 ...
 * @brief  NO_INIT_SECTION
 *         Use the NO_INIT_SECTION macro to declare a not initialized variable.
 *         In order to work properly this macro should be aligned with the
 * linker file. Usage:  NO_INIT_SECTION(int my_no_init_var, "MySection") Usage:
 * NO_INIT_SECTION(uint16_t my_no_init_array[10], "MySection")
 */
 ...
 *         Use the NOSTACK_FUNCTION macro to indicate that function should not
 * use any stack. Typical usage is for hard fault handler, to avoid altering the
 * value of the stack pointer. In keil this is a dummy implementation since no
 * equivalent function is available Usage:  NOSTACK_FUNCTION(void
 * my_noretrun_function(void))
 */
 ...
 * @brief  NO_INIT_SECTION
 *         Use the NO_INIT_SECTION macro to declare a not initialized variable
 * that should be placed in a specific section. Linker script is in charge of
 * placing that section in RAM. Usage:  NO_INIT_SECTION(int my_no_init_var,
 * "MySection") Usage:  NO_INIT_SECTION(uint16_t my_no_init_array[10],
 * "MySection")
 */
