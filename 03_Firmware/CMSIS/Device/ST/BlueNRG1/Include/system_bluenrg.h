/**
 ******************************************************************************
 * @file    system_bluenrg.h
 * @author  AMS RF-Application Team
 * @version V1.2.0
 * @date    21-November-2018
 * @brief   This file contains all the functions prototypes for the CRMU
 *firmware library.
 ******************************************************************************
 * @attention
 *
...
/** @addtogroup system_bluenrg_device_configuration Device Configuration
 * Constants
 * @{
 */
...
/* Exported macro ------------------------------------------------------------*/
   ...
   * reports the name of the source file and the source line number of the call
...
#define assert_param(expr) ((void)0)
  ...
  extern volatile uint32_t rfTimeout;
...
/* Important note: The __low_level_init() function is critical for waking up
   from deep sleep and it should not use more that 20 stack positions otherwise
   a stack corruption will occur when waking up from deep sleep. For this reason
   we are saving and restoring the first 20 words of the stack that will be
   corrupted during the wake-up procedure from deep sleep. If the
   __low_level_init() will be modified, this define shall be modifed according
