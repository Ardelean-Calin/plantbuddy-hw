...
/* Macro to be used to call ACI functions from a thread different from the
BLETask. It also unblock it. E.g.: BLE_ACI_PROTECTED(ret =
hci_le_set_advertising_data(sizeof(data),data));
*/
...
/* Set wakeup GPIOs to be used when FreeRTOS Idle Task will call BlueNRG sleep
 * function */
