...
{
  const uint8_t P256_P_LE[32] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
                                 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff};
  const uint8_t BLE_P256_ABELIAN_ORDER_R_LE[32] = {0x51, 0x25, 0x63, 0xFC, 0xC2, 0xCA, 0xB9, 0xF3,
  ...
  for (idx = 0; idx < 8; idx++) { *(uint32_t*)(StartAddress + 4 * idx) = srcData[idx]; }
...
ErrorStatus PKA_GetData(uint8_t dataType, uint8_t* dataTarget)
{
  ...
  for (uint8_t i = 0; i < 32; i++) { dataTarget[i] = ((uint8_t*)StartAddress)[i]; }
