...
void UART_Cmd(FunctionalState NewState)
{
  ...
  {
    /* Disable the selected UART by clearing the UARTEN bit in the UARTCR
     * register */
    UART->CR_b.EN = RESET;
  }
}
 ...
 * @param  UART_IT: specifies the UART interrupt sources to be enabled or
 * disabled. This parameter can be a any combination of the following values:
...
void UART_DMACmd(uint8_t UART_DMAReq, FunctionalState NewState)
{
  ...
  else
  {
    /* Disable the DMA transfer for selected requests by clearing the DMAT
       and/or DMAR bits in the UART CR3 register */
 ...
 * @param  UART_RxSwFlowCtrlMode: specifies the software flow control used for
 * RX. This parameter can be one of the following values:
 ...
 *   @arg SW_FLOW_CTRL_ALL_CHARS: Software flow control XON1 and XOFF1, XON2 and
 * XOFF2
 * @retval None
 */
 ...
 * @param  UART_TxSwFlowCtrlMode: specifies the software flow control used for
 * TX. This parameter can be one of the following values:
 *   @arg NO_SW_FLOW_CTRL: No software flow control
 *   @arg SW_FLOW_CTRL_XON1_XOFF1: Software flow control XON1 and XOFF1
 *   @arg SW_FLOW_CTRL_XON2_XOFF2: Software flow control XON2 and XOFF2
 *   @arg SW_FLOW_CTRL_ALL_CHARS: Software flow control XON1 and XOFF1, XON2 and
