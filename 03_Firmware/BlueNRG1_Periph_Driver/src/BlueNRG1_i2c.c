...
/**
 * @brief  Deinitializes the I2C peripheral registers to their default reset
 * values.
 * @param  I2Cx: where x can be 1 or 2 to select the I2C peripheral @ref
 * I2C_Type
 * @retval None
 */
 ...
 * @param  I2C_InitStruct: pointer to an @ref I2C_InitType structure which will
 * be initialized.
 * @retval None
 */
 ...
 * @param  I2Cx: where x can be 1 or 2 to select the I2C peripheral @ref
 * I2C_Type
 * @param  I2C_IT: specifies the I2C interrupts sources to be enabled or
 ...
 *         If this number is smaller than the transaction length, only one
 * single request are generated.
 * @param  I2Cx: where x can be 1 or 2 to select the I2C peripheral @ref
 * I2C_Type
