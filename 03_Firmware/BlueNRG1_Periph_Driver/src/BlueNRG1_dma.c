...
#define DMA_CHANNEL0_FLAG_MASK \
  ((uint32_t)(DMA_FLAG_GL0 | DMA_FLAG_TC0 | DMA_FLAG_HT0 | DMA_FLAG_TE0))
#define DMA_CHANNEL1_FLAG_MASK \
  ((uint32_t)(DMA_FLAG_GL1 | DMA_FLAG_TC1 | DMA_FLAG_HT1 | DMA_FLAG_TE1))
#define DMA_CHANNEL2_FLAG_MASK \
  ((uint32_t)(DMA_FLAG_GL2 | DMA_FLAG_TC2 | DMA_FLAG_HT2 | DMA_FLAG_TE2))
#define DMA_CHANNEL3_FLAG_MASK \
  ((uint32_t)(DMA_FLAG_GL3 | DMA_FLAG_TC3 | DMA_FLAG_HT3 | DMA_FLAG_TE3))
#define DMA_CHANNEL4_FLAG_MASK \
  ((uint32_t)(DMA_FLAG_GL4 | DMA_FLAG_TC4 | DMA_FLAG_HT4 | DMA_FLAG_TE4))
#define DMA_CHANNEL5_FLAG_MASK \
  ((uint32_t)(DMA_FLAG_GL5 | DMA_FLAG_TC5 | DMA_FLAG_HT5 | DMA_FLAG_TE5))
#define DMA_CHANNEL6_FLAG_MASK \
  ((uint32_t)(DMA_FLAG_GL6 | DMA_FLAG_TC6 | DMA_FLAG_HT6 | DMA_FLAG_TE6))
#define DMA_CHANNEL7_FLAG_MASK \
  ((uint32_t)(DMA_FLAG_GL7 | DMA_FLAG_TC7 | DMA_FLAG_HT7 | DMA_FLAG_TE7))

#define IS_DMA_ALL_PERIPH(PERIPH)                                             \
  (((PERIPH) == DMA_CH0) || ((PERIPH) == DMA_CH1) || ((PERIPH) == DMA_CH2) || \
   ((PERIPH) == DMA_CH3) || ((PERIPH) == DMA_CH4) || ((PERIPH) == DMA_CH5) || \
   ((PERIPH) == DMA_CH6) || ((PERIPH) == DMA_CH7))
/**
 * @}
 */
...
void DMA_Init(DMA_CH_Type* DMAy_Channelx, DMA_InitType* DMA_InitStruct)
{
  ...
  tmpreg |= DMA_InitStruct->DMA_DIR | DMA_InitStruct->DMA_Mode | DMA_InitStruct->DMA_PeripheralInc |
            DMA_InitStruct->DMA_MemoryInc | DMA_InitStruct->DMA_PeripheralDataSize |
            DMA_InitStruct->DMA_MemoryDataSize | DMA_InitStruct->DMA_Priority |
 ...
 *   This parameter can be any combination (for the same DMA) of the following
 * values:
 *     @arg DMA_FLAG_GL1: DMA Channel1 global flag.
 *     @arg DMA_FLAG_TC1: DMA Channel1 transfer complete flag.
 *     @arg DMA_FLAG_HT1: DMA Channel1 half transfer flag.
 ...
 *
 * @note
 *    Clearing the Global flag (DMAy_FLAG_GLx) results in clearing all other
 * flags relative to the same channel (Transfer Complete, Half-transfer Complete
 * and Transfer Error flags: DMAy_FLAG_TCx, DMAy_FLAG_HTx and DMAy_FLAG_TEx).
 *
 * @retval None
 */
