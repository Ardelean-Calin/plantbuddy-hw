 ...
 *         This parameter can be: ENABLE or DISABLE.
 */
FunctionalState WDG_GetWriteAccess(void) { return (FunctionalState)!WDG->LOCK; }
 ...
 * @retval None
 */
void WDG_DisableReset(void) { WDG->CR_b.RESEN = RESET; }
 ...
 */
uint32_t WDG_GetCounter(void) { return WDG->VAL; }
 ...
 * @retval None
 */
void WDG_ClearITPendingBit(void) { WDG->ICR = 0xFFFFFFFF; }
