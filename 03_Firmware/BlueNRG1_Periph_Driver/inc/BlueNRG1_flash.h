...
#define IS_FLASH_FLAG(FLAG)                                                               \
  (((FLAG) == Flash_CMDDONE) || ((FLAG) == Flash_CMDSTART) || ((FLAG) == Flash_CMDERR) || \
   ((FLAG) == Flash_ILLCMD) || ((FLAG) == Flash_READOK) || ((FLAG) == Flash_FLNREADY))
  /**
   * @}
   */
...
#define IS_FLASH_CMD(CMD)                                                        \
  (((CMD) == FLASH_ERASE) || ((CMD) == FLASH_MASSERASE)((CMD) == FLASH_WRITE) || \
   ((CMD) == FLASH_MASSWRITE)((CMD) == FLASH_MASSREAD) ||                        \
   ((CMD) == FLASH_BURSTWRITE)((CMD) == FLASH_SLEEP) || ((CMD) == FLASH_WAKEUP))
