...
#include "bluenrg_x_device.h"
  ...
  typedef struct
  {
    ...
    uint32_t RTC_PATTERN1; /*!< Define the pattern, '0' relaod TLR1 and '1'
                           reload TLR2. First 32 bit pattern  */

    uint32_t RTC_PATTERN2; /*!< Define the pattern, '0' relaod TLR1 and '1'
                           reload TLR2. Second 32 bit pattern  */

    uint32_t RTC_PATTERN3; /*!< Define the pattern, '0' relaod TLR1 and '1'
                           reload TLR2. Third 32 bit pattern */

    uint32_t RTC_PATTERN4; /*!< Define the pattern, '0' relaod TLR1 and '1'
                           reload TLR2. Fourth 32 bit pattern */
  } RTC_InitType;
  ...
  typedef struct
  {
    ...
    uint8_t WeekDay; /*!< Specify the present day in the week to be set to RTC
                       clockwatch. This parameter can be an integer value in
                       range from 0 to 7 */

    uint8_t MonthDay; /*!< Specify the present day in the month to be set to RTC
                         clockwatch. This parameter can be an integer value in
                         range from 1 to 31 (depends on month) */

    uint8_t Month; /*!< Specify the present month to be set to RTC clockwatch.
                     This parameter can be an integer value in range from 1 to
                     12 (depends on month) */

    uint16_t Year; /*!< Specify the present year to be set to RTC clockwatch.
                     This parameter can be an integer value in range from 0 to
                     3999 (depends on month) */
...
#define IS_RTC_IT(IT) (((IT) == RTC_IT_CLOCKWATCH) || ((IT) == RTC_IT_TIMER))

/**
 * @}
 */

/** @defgroup RTC_Timer_Operating_Mode_Definitions    Timer Operating Mode
 * Definitions
 * @{
 */
...
/** This macro checks if IT is a valid combination of interrupt */
#define IS_RTC_TIMER_MODE(IT) (((IT) == RTC_TIMER_PERIODIC) || ((IT) == RTC_TIMER_ONESHOT))
