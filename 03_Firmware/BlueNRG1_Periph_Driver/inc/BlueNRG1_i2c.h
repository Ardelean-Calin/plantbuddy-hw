...
#include "bluenrg_x_device.h"
  ...
  typedef enum
  {
    ...
    I2C_OP_OK,      /*! OK: The operation (OP field) has been completed successfully
                     */
    I2C_OP_ABORTED, /*! <ABORT: The operation (OP field) has been aborted due to
                       the
                                                                                 occurrence of the
                       event described in the CAUSE field. */
  } I2C_OpStatus;
...
#define IS_I2C_ALL_PERIPH(I2CX) (((I2CX) == I2C1) || ((I2CX) == I2C2))
...
#define I2C_Filtering_2Ck_Spikes              \
  ((uint8_t)0x02) /*!< Filters 2 clock spikes \
                   */
#define I2C_Filtering_4Ck_Spikes              \
  ((uint8_t)0x03) /*!< Filters 4 clock spikes \
                   */

/** This macro checks if FILTER is a valid filtering value */
#define IS_I2C_FILTERING(FILTER)                                               \
  (((FILTER) == I2C_Filtering_Off) || ((FILTER) == I2C_Filtering_1Ck_Spike) || \
   ((FILTER) == I2C_Filtering_2Ck_Spikes) || ((FILTER) == I2C_Filtering_4Ck_Spikes))
  /**
   * @}
   */
...
#define IS_I2C_OPERATING_MODE(MODE)                                               \
  (((MODE) == I2C_OperatingMode_Master) || ((MODE) == I2C_OperatingMode_Slave) || \
...
#define IS_I2C_OPERATION(OP) (((OP) == I2C_Operation_Write) || ((OP) == I2C_Operation_Read))
...
#define I2C_StartByte_Disable                     \
  ((uint16_t)0x0000) /*!< Disables the start byte \
                      */
#define I2C_StartByte_Enable ((uint16_t)0x0800) /*!< Enables the start byte */

/** This macro checks if SB is a valid StartByte value */
#define IS_I2C_STARTBYTE(SB) (((SB) == I2C_StartByte_Disable) || ((SB) == I2C_StartByte_Enable))
...
#define IS_I2C_ADDRESSTYPE(AT)                                                \
  (((AT) == I2C_AddressType_GeneralCall) || ((AT) == I2C_AddressType_7Bit) || \
...
#define IS_I2C_STOPCONDITION(P) \
  (((P) == I2C_StopCondition_Disable) || ((P) == I2C_StopCondition_Enable))
