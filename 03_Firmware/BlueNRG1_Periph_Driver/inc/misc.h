...
#include "bluenrg_x_device.h"
  ...
  typedef struct
  {
    uint8_t NVIC_IRQChannel; /*!< Specifies the IRQ channel to be enabled or
                                disabled. This parameter can be a value of @ref
                                IRQn_Type (For the complete BlueNRG1 Device IRQ
                                Channels list, please refer to BlueNRG1.h file) */

    uint8_t NVIC_IRQChannelPreemptionPriority; /*!< Specifies the pre-emption
                                                  priority for the IRQ channel
...
/** @defgroup Preemption_Priority_Definitions Preemption Priority Group
 * Definitions
 * @{
 */
